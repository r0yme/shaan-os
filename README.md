...
> **Status:** Phase 10 (Time tracking) — authentication, RBAC, design system,
...
> team↔client messaging, an approvals workflow, and time tracking with
> per-member hours. Contractors, file sharing and the rest arrive later.
