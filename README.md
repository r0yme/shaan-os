...
> **Status:** Phase 9 (Approvals) — authentication, RBAC, design system, the
...
> team↔client messaging, and an approvals workflow with a review queue.
> Contractors, time tracking, file sharing and the rest arrive later.
